...
const information = {
        ...
        project6: {
            ...
            website: 'https://www.canva.com/design/DAE_5C5rEcM/csd8G0WAccJXoq15ImvbGw/watch?utm_content=DAE_5C5rEcM&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink',
  ...
  return (
      <div>
            Object.keys(information).map((project) => (
                  <Project key={project.id} title={project.title} body={project.body} website={project.website} github={porject.github}
            ))
      </div>
  )
}